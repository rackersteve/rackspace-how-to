...
The following operating systems are supported for both Dedicated and Managed Cloud:
...
| File and folder transfer between servers        | Yes          |               |                 |

**Note**: These might require additional Rackspace licensing and service agreements.

### Windows OS Billable Services

| Feature or operation                       | Configuration | Troubleshooting |
| ------------------------------------------ | ------------- | --------------- |
| File and folder transfer between servers   | Yes           | Yes             |
